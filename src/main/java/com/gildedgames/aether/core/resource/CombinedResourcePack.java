package com.gildedgames.aether.core.resource;
...
public class CombinedResourcePack extends DelegatingResourcePack
{
    ...
    public CombinedResourcePack(String id, String name, PackMetadataSection packInfo, List<? extends PackResources> packs, Path sourcePack) {
