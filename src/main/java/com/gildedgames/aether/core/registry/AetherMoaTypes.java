...
public class AetherMoaTypes
{
    ...
    public static final MoaType BLUE = register("blue", new MoaType.Properties().egg(AetherItems.BLUE_MOA_EGG).maxJumps(3).speed(0.1F).texture("textures/entity/mobs/moa/blue_moa.png"));
    public static final MoaType WHITE = register("white", new MoaType.Properties().egg(AetherItems.WHITE_MOA_EGG).maxJumps(4).speed(0.1F).texture("textures/entity/mobs/moa/white_moa.png"));
    public static final MoaType BLACK = register("black", new MoaType.Properties().egg(AetherItems.BLACK_MOA_EGG).maxJumps(8).speed(0.1F).texture("textures/entity/mobs/moa/black_moa.png").saddleTexture("textures/entity/mobs/moa/black_moa_saddle.png"));
