...
public class HittingPacket extends BaseAetherPacket
{
    ...
    public void execute(Player playerEntity) {
        if (playerEntity != null && playerEntity.getServer() != null && playerEntity.level.getEntity(this.playerID) instanceof ServerPlayer serverPlayer) {
            AetherPlayerSerializable.get(serverPlayer).ifPresent(aetherPlayer -> aetherPlayer.setHitting(this.isHitting));
        }
    }
}
