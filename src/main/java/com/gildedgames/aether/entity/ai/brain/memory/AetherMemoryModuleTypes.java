...
public class AetherMemoryModuleTypes {
    ...
    public static final RegistryObject<MemoryModuleType<BlockPos>> TARGET_POSITION = MEMORY_TYPES.register("target_position", () -> new MemoryModuleType<>(Optional.empty()));
}
