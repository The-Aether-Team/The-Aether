...
public interface ValkyrieTool {
    ...
    /**
     * Sets up the attributes for the item if it is a valkyrie tool or weapon and is in the entity's main hand, adding attributes for the mining reach distance and the attack range distance alongside the default item attributes.
     ...
     */
    default Multimap<Attribute, AttributeModifier> extendReachModifier(Multimap<Attribute, AttributeModifier> map, ItemStack stack, EquipmentSlot slot) {
