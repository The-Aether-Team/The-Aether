...
public class HolySwordItem extends SwordItem {
    ...
    /**
     * Deals 15 damage to undead mobs or mobs that treat healing and harming effects as inverted, with an extra 2.5 damage for every level of smite the item has. This reduces the item's durability by 10.
