...
public class AetherSkyRenderer implements ISkyRenderHandler {
    ...
    @Override
    public void render(int ticks, float partialTicks, PoseStack matrixStack, ClientLevel world, Minecraft mc) {  //TODO: How do we get a Matrix4f like LevelRenderer.renderSky() does?
