...
public class ZephyrModel extends BaseZephyrModel
{
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation cubeDeformation) {
        ...
        partdefinition.addOrReplaceChild("left_face", CubeListBuilder.create().texOffs(67, 11).addBox(3.0F, -1.0F, -9.0F, 4.0F, 6.0F, 2.0F), PartPose.offset(0.0F, 8.0F, 0.0F));
        ...
        partdefinition.addOrReplaceChild("mouth", CubeListBuilder.create().texOffs(66, 19).addBox(-3.0F, 1.0F, -8.0F, 6.0F, 3.0F, 1.0F), PartPose.offset(0.0F, 8.0F, 0.0F));
        ...
        partdefinition.addOrReplaceChild("body_right_side_1", CubeListBuilder.create().texOffs(0, 20).addBox(-2.0F, -3.0F, -3.0F, 2.0F, 6.0F, 6.0F), PartPose.offset(-6.0F, 8.0F, -4.0F));
        partdefinition.addOrReplaceChild("body_right_side_2", CubeListBuilder.create().texOffs(25, 11).addBox(-2.0F, -3.3333F, -2.5F, 2.0F, 6.0F, 6.0F), PartPose.offset(-5.5F, 9.0F, 2.0F));
        partdefinition.addOrReplaceChild("cloud_butt", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -3.0F, 0.0F, 8.0F, 6.0F, 2.0F), PartPose.offset(2.0F, 8.0F, 7.0F));
