...
public class CustomizationUndoButton extends InactiveImageButton {
    ...
    public CustomizationUndoButton(ColorBox colorBox, int x, int y, int width, int height, int xTexStart, int yTexStart, int yDiffTex, ResourceLocation resourceLocation, int textureWidth, int textureHeight, OnPress onPress, OnTooltip onTooltip, Component message) {
