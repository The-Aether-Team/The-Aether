...
public class AetherMenuButton extends Button
{
	...
	public void renderButton(PoseStack matrixStack, int mouseX, int mouseY, float p_230431_4_) {
	    ...
	    this.blit(matrixStack, this.getX() + this.renderOffset, this.getY(), 0, 46 + i * 20, this.width / 2, this.height);
	    this.blit(matrixStack, (this.getX() + this.width / 2) + this.renderOffset, this.getY(), 200 - this.width / 2, 46 + i * 20, this.width / 2, this.height);
