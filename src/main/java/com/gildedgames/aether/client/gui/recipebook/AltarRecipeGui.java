...
public class AltarRecipeGui extends AbstractRecipeBookGui {
    private static final ITextComponent field_243415_i = new TranslationTextComponent("gui.recipebook.toggleRecipes." + Aether.MODID + ".enchantable");
    ...
    protected Set<Item> func_212958_h() {
        return AltarTileEntity.getEnchantingMap().keySet();
    }
}
