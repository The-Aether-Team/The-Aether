    ...
    public static Biome makeDefaultBiome(BiomeGenerationSettings.Builder builder) {
        return fullDefinition(
                ...
                new MobSpawnSettings.Builder()
                        .addMobCharge(AetherEntityTypes.AECHOR_PLANT.get(), 0.5, 1.2)
                        .addMobCharge(AetherEntityTypes.BLUE_SWET.get(), 0.4, 0.9)
                        .addMobCharge(AetherEntityTypes.GOLDEN_SWET.get(), 0.4, 0.9)
                        .addMobCharge(AetherEntityTypes.ZEPHYR.get(), 1.0, 0.05)
                        .addMobCharge(AetherEntityTypes.WHIRLWIND.get(), 0.7, 0.1)
                        .addMobCharge(AetherEntityTypes.EVIL_WHIRLWIND.get(), 0.7, 0.1)
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.AECHOR_PLANT.get(), 4, 1, 3))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.COCKATRICE.get(), 60, 1, 4))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.ZEPHYR.get(), 100, 1, 1))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.BLUE_SWET.get(), 3, 2, 4))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.GOLDEN_SWET.get(), 3, 2, 4))
