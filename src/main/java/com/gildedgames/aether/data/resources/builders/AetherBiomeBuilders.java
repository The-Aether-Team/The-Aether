...
//                        .addMobCharge(AetherEntityTypes.AECHOR_PLANT.get(), 0.5, 0.1)
//                        .addMobCharge(AetherEntityTypes.BLUE_SWET.get(), 0.5, 0.15)
//                        .addMobCharge(AetherEntityTypes.GOLDEN_SWET.get(), 0.5, 0.15)
                        ...
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.COCKATRICE.get(), 120, 1, 4))
                        ...
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.BLUE_SWET.get(), 1, 2, 4))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.GOLDEN_SWET.get(), 1, 2, 4))
