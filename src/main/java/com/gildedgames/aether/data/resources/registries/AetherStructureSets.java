...
public class AetherStructureSets {
    ...
    public static void bootstrap(BootstapContext<StructureSet> context) {
        ...
        context.register(BRONZE_DUNGEON, new StructureSet(structures.getOrThrow(AetherStructures.BRONZE_DUNGEON), new RandomSpreadStructurePlacement(10, 4, RandomSpreadType.LINEAR, 32146754)));
        context.register(SILVER_AND_GOLD_DUNGEONS, new StructureSet(List.of(
        	...
        	new RandomSpreadStructurePlacement(15, 13, RandomSpreadType.LINEAR, 4325806)));
    }
}
