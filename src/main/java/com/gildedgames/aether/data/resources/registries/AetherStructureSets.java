...
public class AetherStructureSets {
    ...
    public static void bootstrap(BootstapContext<StructureSet> context) {
        ...
        context.register(BRONZE_DUNGEON, new StructureSet(structures.getOrThrow(AetherStructures.BRONZE_DUNGEON), new RandomSpreadStructurePlacement(9, 8, RandomSpreadType.LINEAR, 32146754)));
