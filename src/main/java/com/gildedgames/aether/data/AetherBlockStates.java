...
import com.gildedgames.aether.data.provider.AetherBlockStatesProvider;
import com.gildedgames.aether.registry.AetherBlocks;
import net.minecraft.data.DataGenerator;
import net.minecraftforge.common.data.ExistingFileHelper;

public class AetherBlockStates extends AetherBlockStatesProvider
{
    public AetherBlockStates(DataGenerator generator, ExistingFileHelper fileHelper) {
    ...
    protected void registerStatesAndModels() {
        //TODO: If the double block system is changed to not be blockstate based, a couple of these and the stuff in AetherBlockStatesProvider have to be changed.
        ...
        wallBlock(AetherBlocks.AEROGEL_WALL, AetherBlocks.AEROGEL, "construction/");
        ...
        stairs(AetherBlocks.AEROGEL_STAIRS, AetherBlocks.AEROGEL, "construction/");
