...
public abstract class AetherBlockStatesProvider extends BlockStateProvider
{
    public AetherBlockStatesProvider(DataGenerator generator, ExistingFileHelper fileHelper) {
