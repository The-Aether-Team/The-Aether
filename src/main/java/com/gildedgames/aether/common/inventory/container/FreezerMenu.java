...
public class FreezerMenu extends AbstractFurnaceMenu
{
	public FreezerMenu(int windowId, Inventory playerInventory) {
		super(AetherContainerTypes.FREEZER.get(), RecipeTypes.FREEZING, AetherRecipeBookTypes.FREEZER, windowId, playerInventory);
	}

	public FreezerMenu(int windowId, Inventory playerInventory, Container freezingInventory, ContainerData furnaceData) {
		super(AetherContainerTypes.FREEZER.get(), RecipeTypes.FREEZING, AetherRecipeBookTypes.FREEZER, windowId, playerInventory, freezingInventory, furnaceData);
	}
