...
public class ItemBanRecipeBuilder extends PlacementBanBuilder {
    ...
    public ItemBanRecipeBuilder(Ingredient ingredient, @Nullable BlockStateIngredient bypassBlock, @Nullable ResourceKey<DimensionType> dimensionTypeKey, @Nullable TagKey<DimensionType> dimensionTypeTag, PlacementBanRecipeSerializer<ItemStack, Ingredient, ItemBanRecipe> serializer) {
        super(bypassBlock, dimensionTypeKey, dimensionTypeTag, serializer);
        this.ingredient = ingredient;
    }

    public static PlacementBanBuilder recipe(Ingredient ingredient, @Nullable ResourceKey<DimensionType> dimensionTypeKey, PlacementBanRecipeSerializer<ItemStack, Ingredient, ItemBanRecipe> serializer) {
        return recipe(ingredient, BlockStateIngredient.EMPTY, dimensionTypeKey, null, serializer);
    }

    public static PlacementBanBuilder recipe(Ingredient ingredient, @Nullable TagKey<DimensionType> dimensionTypeTag, PlacementBanRecipeSerializer<ItemStack, Ingredient, ItemBanRecipe> serializer) {
        return recipe(ingredient, BlockStateIngredient.EMPTY, null, dimensionTypeTag, serializer);
    }

    public static PlacementBanBuilder recipe(Ingredient ingredient, BlockStateIngredient bypassBlock, @Nullable ResourceKey<DimensionType> dimensionTypeKey, PlacementBanRecipeSerializer<ItemStack, Ingredient, ItemBanRecipe> serializer) {
        return recipe(ingredient, bypassBlock, dimensionTypeKey, null, serializer);
    }

    public static PlacementBanBuilder recipe(Ingredient ingredient, BlockStateIngredient bypassBlock, @Nullable TagKey<DimensionType> dimensionTypeTag, PlacementBanRecipeSerializer<ItemStack, Ingredient, ItemBanRecipe> serializer) {
        return recipe(ingredient, bypassBlock, null, dimensionTypeTag, serializer);
    }

    public static PlacementBanBuilder recipe(Ingredient ingredient, BlockStateIngredient bypassBlock, @Nullable ResourceKey<DimensionType> dimensionTypeKey, @Nullable TagKey<DimensionType> dimensionTypeTag, PlacementBanRecipeSerializer<ItemStack, Ingredient, ItemBanRecipe> serializer) {
