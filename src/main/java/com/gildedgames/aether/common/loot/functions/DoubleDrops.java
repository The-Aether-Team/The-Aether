...
public class DoubleDrops extends LootItemConditionalFunction
{
	...
	protected ItemStack run(ItemStack stack, LootContext context) {
		...
		if (tool != null && tool.is(AetherTags.Items.SKYROOT_TOOLS) && EnchantmentHelper.getItemEnchantmentLevel(Enchantments.SILK_TOUCH, tool) == 0 && EnchantmentHelper.getItemEnchantmentLevel(Enchantments.SILK_TOUCH, tool) == 0) {
