...
public class PlacementModifiers {
    ...
    public static final PlacementModifierType<TallGrassFilter> CONFIG_FILTER = register(new ResourceLocation(Aether.MODID, "tall_grass_filter"), TallGrassFilter.CODEC);
