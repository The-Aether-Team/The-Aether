...
public class AetherContainerTypes
{
	...
	public static final RegistryObject<ContainerType<AccessoriesContainer>> ACCESSORIES = CONTAINERS.register("accessories", () -> new ContainerType<>(AccessoriesContainer::new));
