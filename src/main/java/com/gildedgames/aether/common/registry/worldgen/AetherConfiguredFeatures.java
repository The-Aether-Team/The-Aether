...
public class AetherConfiguredFeatures {
    ...
    public static final Holder<ConfiguredFeature<AercloudConfiguration, ?>> COLD_AERCLOUD = register("cold_aercloud", AetherFeaturesForge.AERCLOUD.get(),
            createAercloudConfig(16, AetherBlocks.COLD_AERCLOUD.get().defaultBlockState()));
    public static final Holder<ConfiguredFeature<AercloudConfiguration, ?>> BLUE_AERCLOUD = register("blue_aercloud", AetherFeaturesForge.AERCLOUD.get(),
            createAercloudConfig(8, AetherBlocks.BLUE_AERCLOUD.get().defaultBlockState()));
    public static final Holder<ConfiguredFeature<AercloudConfiguration, ?>> GOLDEN_AERCLOUD = register("golden_aercloud", AetherFeaturesForge.AERCLOUD.get(),
            createAercloudConfig(4, AetherBlocks.GOLDEN_AERCLOUD.get().defaultBlockState()));
    public static final Holder<ConfiguredFeature<AercloudConfiguration, ?>> PINK_AERCLOUD = register("pink_aercloud", AetherFeaturesForge.AERCLOUD.get(),
    ...
    public static final Holder<ConfiguredFeature<SimpleDiskConfiguration, ?>> QUICKSOIL_SHELF_CONFIGURED_FEATURE = register("quicksoil_shelf", AetherFeaturesForge.SIMPLE_DISK.get(),
    ...
    public static <FC extends FeatureConfiguration, F extends Feature<FC>> Holder<ConfiguredFeature<FC, ?>> register(String name, F feature, FC configuredFeature) {
        return BuiltinRegistries.registerExact(BuiltinRegistries.CONFIGURED_FEATURE, new ResourceLocation(Aether.MODID, name).toString(), new ConfiguredFeature<>(feature, configuredFeature));
    }
}
