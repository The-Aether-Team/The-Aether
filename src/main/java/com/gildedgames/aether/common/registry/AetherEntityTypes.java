...
public class AetherEntityTypes
{
	...
	// Passive Mobs
	public static final EntityType<PhygEntity> PHYG_TYPE = EntityType.Builder.<PhygEntity>of(PhygEntity::new, MobCategory.CREATURE).sized(0.9F, 0.9F).clientTrackingRange(10).build("phyg");
	public static final RegistryObject<EntityType<PhygEntity>> PHYG = ENTITIES.register("phyg", () -> PHYG_TYPE);

	public static final EntityType<FlyingCowEntity> FLYING_COW_TYPE = EntityType.Builder.<FlyingCowEntity>of(FlyingCowEntity::new, MobCategory.CREATURE).sized(0.9F, 1.4F).clientTrackingRange(10).build("flying_cow");
	public static final RegistryObject<EntityType<FlyingCowEntity>> FLYING_COW = ENTITIES.register("flying_cow", () -> FLYING_COW_TYPE);

	public static final EntityType<SheepuffEntity> SHEEPUFF_TYPE = EntityType.Builder.<SheepuffEntity>of(SheepuffEntity::new, MobCategory.CREATURE).sized(0.9F, 1.3F).clientTrackingRange(10).build("sheepuff");
	public static final RegistryObject<EntityType<SheepuffEntity>> SHEEPUFF = ENTITIES.register("sheepuff", () -> SHEEPUFF_TYPE);

	public static final EntityType<MoaEntity> MOA_TYPE = EntityType.Builder.<MoaEntity>of(MoaEntity::new, MobCategory.CREATURE).sized(1.0F,  2.0F).build("moa");
	public static final RegistryObject<EntityType<MoaEntity>> MOA = ENTITIES.register("moa", () -> MOA_TYPE);

	public static final EntityType<AerwhaleEntity> AERWHALE_TYPE = EntityType.Builder.<AerwhaleEntity>of(AerwhaleEntity::new, MobCategory.CREATURE).sized(3.0F, 3.0F).fireImmune().build("aerwhale");
	public static final RegistryObject<EntityType<AerwhaleEntity>> AERWHALE = ENTITIES.register("aerwhale", () -> AERWHALE_TYPE);

	public static final EntityType<AerbunnyEntity> AERBUNNY_TYPE = EntityType.Builder.<AerbunnyEntity>of(AerbunnyEntity::new, MobCategory.CREATURE).sized(0.4F, 0.4F).build("aerbunny");
	public static final RegistryObject<EntityType<AerbunnyEntity>> AERBUNNY = ENTITIES.register("aerbunny", () -> AERBUNNY_TYPE);

	// Hostile Mobs
	//Swet

	public static final EntityType<WhirlwindEntity> WHIRLWIND_TYPE = EntityType.Builder.<WhirlwindEntity>of(WhirlwindEntity::new, MobCategory.MONSTER).sized(0.6F, 0.8F).build("whirlwind");
	public static final RegistryObject<EntityType<WhirlwindEntity>> WHIRLWIND = ENTITIES.register("whirlwind", () -> WHIRLWIND_TYPE);

	public static final EntityType<AechorPlantEntity> AECHOR_PLANT_TYPE = EntityType.Builder.<AechorPlantEntity>of(AechorPlantEntity::new, MobCategory.MONSTER).sized(1.0F, 1.0F).build("aechor_plant");
	...
	public static final EntityType<CockatriceEntity> COCKATRICE_TYPE = EntityType.Builder.<CockatriceEntity>of(CockatriceEntity::new, MobCategory.MONSTER).sized(1.0F, 2.0F).build("cockatrice");
	...
	public static final EntityType<MimicEntity> MIMIC_TYPE = EntityType.Builder.<MimicEntity>of(MimicEntity::new, MobCategory.MONSTER).sized(1.0F, 2.0F).build("mimic");
	...
	public static final EntityType<ColdParachuteEntity> COLD_PARACHUTE_TYPE = EntityType.Builder.of(ColdParachuteEntity::new, MobCategory.MISC).sized(1.0F, 1.0F).build("cold_parachute");
	...
	public static final EntityType<GoldenParachuteEntity> GOLDEN_PARACHUTE_TYPE = EntityType.Builder.of(GoldenParachuteEntity::new, MobCategory.MISC).sized(1.0F, 1.0F).build("golden_parachute");
	...
	public static final EntityType<FloatingBlockEntity> FLOATING_BLOCK_TYPE = EntityType.Builder.<FloatingBlockEntity>of(FloatingBlockEntity::new, MobCategory.MISC).sized(1.0F, 1.0F).updateInterval(1).build("floating_block");
	...
	public static final EntityType<TNTPresentEntity> TNT_PRESENT_TYPE = EntityType.Builder.<TNTPresentEntity>of(TNTPresentEntity::new, MobCategory.MISC).sized(1.0F, 1.0F).build("tnt_present");
	...
	public static final EntityType<ZephyrSnowballEntity> ZEPHYR_SNOWBALL_TYPE = EntityType.Builder.<ZephyrSnowballEntity>of(ZephyrSnowballEntity::new, MobCategory.MISC).sized(1.0F, 1.0F).build("zephyr_snowball");
	...
	public static final EntityType<CloudCrystalEntity> CLOUD_CRYSTAL_TYPE = EntityType.Builder.<CloudCrystalEntity>of(CloudCrystalEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).build("cloud_crystal");
	...
	public static final EntityType<GoldenDartEntity> GOLDEN_DART_TYPE = EntityType.Builder.<GoldenDartEntity>of(GoldenDartEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).build("golden_dart");
	...
	public static final EntityType<PoisonDartEntity> POISON_DART_TYPE = EntityType.Builder.<PoisonDartEntity>of(PoisonDartEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).build("poison_dart");
	...
	public static final EntityType<EnchantedDartEntity> ENCHANTED_DART_TYPE = EntityType.Builder.<EnchantedDartEntity>of(EnchantedDartEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).build("enchanted_dart");
	...
	public static final EntityType<PoisonNeedleEntity> POISON_NEEDLE_TYPE = EntityType.Builder.<PoisonNeedleEntity>of(PoisonNeedleEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).build("poison_needle");
	...
	public static final EntityType<LightningKnifeEntity> LIGHTNING_KNIFE_TYPE = EntityType.Builder.<LightningKnifeEntity>of(LightningKnifeEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).build("lightning_knife");
	...
	public static final EntityType<HammerProjectileEntity> HAMMER_PROJECTILE_TYPE = EntityType.Builder.<HammerProjectileEntity>of(HammerProjectileEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).build("hammer_projectile");
	...
	public static void registerSpawnPlacements() {
		...
		SpawnPlacements.register(AetherEntityTypes.WHIRLWIND.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WhirlwindEntity::canWhirlwindSpawn);
		...
		SpawnPlacements.register(AetherEntityTypes.ZEPHYR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, ZephyrEntity::canZephyrSpawn);
	}
