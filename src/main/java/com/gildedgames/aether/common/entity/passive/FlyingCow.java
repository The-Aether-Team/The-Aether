...
public class FlyingCow extends WingedAnimal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.25, Ingredient.m_204132_(AetherTags.Items.FLYING_COW_TEMPTATION_ITEMS), false));
    ...
    public boolean isFood(ItemStack stack) {
        return stack.m_204117_(AetherTags.Items.FLYING_COW_TEMPTATION_ITEMS);
    }
