...
//    public static boolean canAerwhaleSpawn(EntityType<? extends Aerwhale> aerwhale, LevelAccessor level, MobSpawnType spawnReason, BlockPos pos, Random random) {
//        return !level.getBlockCollisions(aerwhale, aerwhale.getBoundingBox()).iterator().hasNext() && !level.containsAnyLiquid(aerwhale.getBoundingBox()) && level.getRawBrightness(pos, 0) > 8; //TODO: How to get bounding box from entity type.
//    }
}
...
//public class OldAerwhaleEntity
//{
