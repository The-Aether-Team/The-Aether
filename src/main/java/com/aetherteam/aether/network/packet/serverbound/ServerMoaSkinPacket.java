...
public abstract class ServerMoaSkinPacket {
    ...
    public record Apply(UUID playerUUID, MoaData moaSkinData) implements BasePacket {
        public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Aether.MODID, "apply_moa_skin_server");
    ...
    public record Remove(UUID playerUUID) implements BasePacket {
        public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Aether.MODID, "remove_moa_skin_server");
