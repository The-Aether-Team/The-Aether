		...
		for (int i = 0; i < 128; ++i) {
			...
			if (blockState.isAir()) {
				...
				if (random.nextInt(8) == 0) {
					...
					featureHolder = level.registryAccess().registryOrThrow(Registry.PLACED_FEATURE_REGISTRY).getHolderOrThrow(AetherPlacedFeatures.ENCHANTED_AETHER_GRASS_BONEMEAL);
				}
