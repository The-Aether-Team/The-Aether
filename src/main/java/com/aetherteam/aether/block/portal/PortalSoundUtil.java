...
public final class PortalSoundUtil {
    ...
    public static void playPortalSound(LocalPlayer localPlayer) {
        Minecraft.getInstance().getSoundManager().play(SimpleSoundInstance.forLocalAmbience(AetherSoundEvents.BLOCK_AETHER_PORTAL_TRAVEL.get(), localPlayer.level().getRandom().nextFloat() * 0.4F + 0.8F, 0.25F));
    }
}
