...
public class MoaSkins {
    ...
    public static void registerMoaSkins() {
        ...
        register("pink_moa", new MoaSkin("pink_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/pink_moa_icon.png"))
        ...
        register("bronze_moa", new MoaSkin("bronze_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/bronze_moa_icon.png"))
        ...
        register("silver_moa", new MoaSkin("silver_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/silver_moa_icon.png"))
        ...
        register("gold_moa", new MoaSkin("gold_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/gold_moa_icon.png"))
