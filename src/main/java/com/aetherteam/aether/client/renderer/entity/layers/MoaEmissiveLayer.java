...
public class MoaEmissiveLayer extends RenderLayer<Moa, MoaModel> {
    ...
    private ResourceLocation getMoaSkinLocation(Moa moa) {
        ...
        } else if (userSkinsData.containsKey(lastRiderUUID) && userSkinsData.get(lastRiderUUID).moaUUID() != null && userSkinsData.get(lastRiderUUID).moaSkin() != null && userSkinsData.get(lastRiderUUID).moaUUID().equals(moaUUID)) {
