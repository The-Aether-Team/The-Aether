...
public class AetherModelLayers {
    ...
    public static final ModelLayerLocation PHYG_BABY = register("phyg_baby");
    public static final ModelLayerLocation PHYG_BABY_SADDLE = register("phyg_baby", "saddle");
    ...
    public static final ModelLayerLocation FLYING_COW_BABY = register("flying_cow_baby");
    public static final ModelLayerLocation FLYING_COW_BABY_SADDLE = register("flying_cow_baby", "saddle");
    ...
    public static final ModelLayerLocation SHEEPUFF_BABY = register("sheepuff_baby");
    public static final ModelLayerLocation SHEEPUFF_BABY_WOOL = register("sheepuff_baby", "outer");
    public static final ModelLayerLocation SHEEPUFF_BABY_WOOL_PUFFED = register("sheepuff_baby", "outer_puffed");
