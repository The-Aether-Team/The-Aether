...
public abstract class BipedBirdModel<T extends Entity & WingedBird & NotGrounded> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation cube) {
        ...
        PartDefinition head = partDefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 13).addBox(-2.0F, -4.001F, -6.0F, 4.0F, 4.0F, 8.0F, cube, 0.5F, 0.5F), PartPose.offset(0.0F, 8.0F, -4.0F));
        ...
        head.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(22, 0).addBox(-1.0F, 0.0F, -1.001F, 2.0F, 6.0F, 2.0F, cube, 0.5F, 0.5F), PartPose.ZERO);
