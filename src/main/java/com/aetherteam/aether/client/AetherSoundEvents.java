...
public class AetherSoundEvents {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> ITEM_MUSIC_DISC_KLEPTO = register("item.music_disc.klepto");
    public static final DeferredHolder<SoundEvent, SoundEvent> ITEM_MUSIC_DISC_SLIDERS_WRATH = register("item.music_disc.sliders_wrath");
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> ENTITY_SUN_SPIRIT_SHOOT_FIRE = register("entity.sun_spirit.shoot_fire");
    public static final DeferredHolder<SoundEvent, SoundEvent> ENTITY_SUN_SPIRIT_SHOOT_ICE = register("entity.sun_spirit.shoot_ice");
