...
public class AetherParticleTypes {
	...
	public static void registerParticleFactories(RegisterParticleProvidersEvent event) {
		...
		event.registerSpriteSet(PASSIVE_WHIRLWIND.get(), PassiveWhirlyParticle.Factory::new);
		event.registerSpriteSet(EVIL_WHIRLWIND.get(), EvilWhirlyParticle.Factory::new);
