...
public class MoaSkinsScreen extends Screen {
    ...
    public void init() {
        ...
        if (this.getMinecraft().player != null) {
            ...
            this.addRenderableWidget(new PatreonButton(new Builder(Component.translatable("?"),
                    (pressed) -> this.getMinecraft().setScreen(new ConfirmLinkScreen((callback) -> {
                        if (callback) {
            ...
            ).bounds(this.leftPos + (this.imageWidth / 2) + 63, this.topPos + this.imageHeight - 25, 18, 18), true));
        }
    }
