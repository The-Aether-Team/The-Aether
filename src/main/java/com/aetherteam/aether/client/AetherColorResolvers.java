...
public class AetherColorResolvers {
    ...
    static void registerBlockColor() {
        ...
        map.put(Blocks.GRASS, ColorProviderRegistry.BLOCK.get(Blocks.GRASS));
        map.put(Blocks.FERN, ColorProviderRegistry.BLOCK.get(Blocks.FERN));
        map.put(Blocks.TALL_GRASS, ColorProviderRegistry.BLOCK.get(Blocks.TALL_GRASS));
        map.put(Blocks.LARGE_FERN, ColorProviderRegistry.BLOCK.get(Blocks.LARGE_FERN));
    ...
    static void registerItemColor() {
        ColorProviderRegistry.ITEM.register((color, itemProvider) -> itemProvider > 0 ? -1 : ((DyeableLeatherItem) color.getItem()).getColor(color), AetherItems.LEATHER_GLOVES.get());
        for (MoaEggItem moaEggItem : MoaEggItem.moaEggs()) {
            ColorProviderRegistry.ITEM.register((color, itemProvider) -> moaEggItem.getColor(), moaEggItem);
        }
    }
