...
public abstract class SilverDungeonPiece extends AetherTemplateStructurePiece {
    protected static final RuleProcessor LOCKED_ANGELIC_STONE = new RuleProcessor(ImmutableList.of(
    ...
    protected static final RuleProcessor TRAPPED_ANGELIC_STONE = new RuleProcessor(ImmutableList.of(
