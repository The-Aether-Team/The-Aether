...
public class AetherMenus {
    ...
    // Icons
    private static final ResourceLocation THE_AETHER_ICON = new ResourceLocation(Aether.MODID, "textures/gui/menu_api/menu_icon_aether");
    ...
    // Behavior
    private static final BooleanSupplier MINECRAFT_LEFT_CONDITION = () -> NitrogenConfig.CLIENT.active_menu.get().equals("aether:minecraft_left") || (NitrogenConfig.CLIENT.active_menu.get().equals("nitrogen:minecraft") && AetherConfig.CLIENT.menu_type_toggles_alignment.get() && AetherConfig.CLIENT.enable_world_preview.get());
