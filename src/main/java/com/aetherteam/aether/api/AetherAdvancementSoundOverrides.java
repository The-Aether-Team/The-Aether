...
public class AetherAdvancementSoundOverrides {
    ...
    public static final Registry<AdvancementSoundOverride> ADVANCEMENT_SOUND_OVERRIDE_REGISTRY = FabricRegistryBuilder.createSimple(ADVANCEMENT_SOUND_OVERRIDE_REGISTRY_KEY).buildAndRegister();
