...
public interface SkyrootWeapon {
     ...
     * @see com.aetherteam.aether.item.combat.SkyrootSwordItem
     */
     ...
     * The items that will be doubled are tracked in newDrops and added into drops which {@link com.aetherteam.aether.item.combat.SkyrootSwordItem#doSkyrootDoubleDrops(LivingDropsEvent)} has access to.
     * @param target The killed {@link LivingEntity}.
