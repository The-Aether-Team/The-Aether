...
public class AetherLanguageData extends AetherLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addLore(AetherItems.BLUE_GUMMY_SWET, "A sweet-smelling gummy, it can be found in random chests in Bronze and Silver dungeons. It restores the player's hunger to fullness. Very useful for boss fights.");
        ...
        addLore(AetherItems.GINGERBREAD_MAN, "Found in presents under Holiday Trees, these are the most common of holiday items. They are very abundant when dropped from Presents.");
        ...
        addLore(AetherItems.GOLDEN_GUMMY_SWET, "A sour-tasting gummy, it can be found in random chests in Bronze and Silver Dungeons. It restores the player's hunger to fullness. Very useful for boss fights.");
        ...
        addLore(AetherItems.GRAVITITE_SWORD, "Part of Aether's best tool tier. When attacking with this powerful weapon, anything you hit will be flung into the air, causing lots of damage!");
        ...
        addLore(AetherItems.HOLYSTONE_PICKAXE, "One of Aether's stone tools. It can mine Zanite Ore and will randomly drop Ambrosium Shards while mining.");
        ...
        addLore(AetherItems.SKYROOT_HOE, "One of Aether's wooden tools, used to till dirt to allow for the planting of crops. Famously underappreciated.");
        ...
        addLore(AetherItems.SKYROOT_PICKAXE, "One of Aether's wooden tools. When mining Holystone or Ambrosium Ore, the drops will be doubled. This is even better when combined with an enchantment such as Fortune when mining Ambrosium Shards!");
        ...
        addLore(AetherItems.SKYROOT_STICK, "Crafted from Skyroot Planks. Used to create various Aether tools and items. There's nothing else too special about it.");
        addLore(AetherItems.SKYROOT_SWORD, "One of Aether's wooden tool. It has a low amount of durability and doubles mob drops. It makes an excellent weapon for collecting food when combined with enchantments such as Looting and Fire Aspect.");
        ...
        addLore(AetherItems.ZANITE_SHOVEL, "One of Aether's mid-tier tools, as you mine Aether Dirt and Quicksoil, the durability will decrease and the Shovel will get faster. If you wait long enough, it will start breaking blocks instantly! Be careful repairing it, as it will be slower when there is more durability.");
        addLore(AetherItems.ZANITE_SWORD, "One of Aether's mid-tier tools, the attack damage on this sword starts at iron level and will get to at most double when its durability is low.");
