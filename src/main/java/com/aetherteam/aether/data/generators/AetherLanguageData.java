...
public class AetherLanguageData extends AetherLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addLore(AetherBlocks.AETHER_DIRT_PATH, "A path made from flattening Aether Dirt with a Shovel, good for long roads or just exterior gardens.");
        ...
        addLore(AetherBlocks.AMBROSIUM_TORCH, "The main light source for the Aether, made with a Skyroot Stick and Ambrosium Shard.");
