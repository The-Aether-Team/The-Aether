...
public class AetherLanguageData extends AetherLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.addProTip("skyroot_tool_ability", "Pro Tip: Skyroot tools gain double drops from blocks.");
        this.addProTip("holystone_tool_ability", "Pro Tip: Holystone tools occasionally generate Ambrosium Shards.");
        this.addProTip("zanite_tool_ability", "Pro Tip: Zanite tools gain strength the more they are used.");
        this.addProTip("gravitite_tool_ability", "Pro Tip: Gravitite tools can levitate blocks when right-clicking.");
        this.addProTip("white_aerclouds", "Pro Tip: Cold Aerclouds prevent fall damage when landed upon.");
        this.addProTip("blue_aerclouds", "Pro Tip: Blue Aerclouds are bouncy, and launch mobs very high in the air.");
        this.addProTip("phyg_saddle", "Pro Tip: Placing a Saddle on Flying Pigs makes them a mount.");
        this.addProTip("moa_egg_incubation", "Pro Tip: Moa Eggs can be incubated into baby Moas with the Incubator.");
        this.addProTip("gravitite_ore_enchanting", "Pro Tip: Gravitite Ore can be enchanted into Enchanted Gravitite.");
        this.addProTip("enchanted_gravitite_floating", "Pro Tip: Enchanted Gravitite only floats up when powered.");
        this.addProTip("enchanted_gravitite_crafting", "Pro Tip: Enchanted Gravitite can be crafted into armor and tools.");
        this.addProTip("gravitite_armour_ability", "Pro Tip: Gravitite armor grants you higher jumps and no fall damage.");
        this.addProTip("moa_nature_staff", "Pro Tip: Baby Moas will stay put when right clicking them with a Nature Staff.");
        this.addProTip("golden_oak_amber", "Pro Tip: Golden Oak Trees yield valuable Golden Amber in their logs.");
        this.addProTip("altar_repairing", "Pro Tip: Altars can repair damaged items and enhance existing items.");
        this.addProTip("glowstone_portal_forming", "Pro Tip: Place water into a Glowstone frame for a Hostile Paradise.");
        this.addProTip("champs", "Pro Tip: The Champs and Champettes are pretty baller.");
        this.addProTip("ambrosium_shard_fuel", "Pro Tip: Ambrosium Shards are great for fueling Altars.");
        this.addProTip("icestone_freezing_blocks", "Pro Tip: Icestone freezes water into Ice and lava into Obsidian.");
        this.addProTip("mimic_chest", "Pro Tip: Some dungeons in the Aether contain Chests which are Chest Mimics.");
        this.addProTip("cold_parachute_crafting", "Pro Tip: Cold Parachutes can be crafted with 4 Cold Aercloud blocks.");
        this.addProTip("parachute_activation", "Pro Tip: Parachutes auto-activate when falling off an island.");
        this.addProTip("golden_parachute_durability", "Pro Tip: Golden Parachutes have 20 uses rather than one.");
        this.addProTip("aerogel_explosion_resistance", "Pro Tip: Aerogel acts as an explosion-resistant, transparent block.");
        this.addProTip("quicksoil_sliding", "Pro Tip: Quicksoil increases the speed of walking mobs and sliding items.");
        this.addProTip("dungeon_rewards", "Pro Tip: Dungeons can contain extremely powerful and unique rewards.");
        this.addProTip("dungeon_tiers", "Pro Tip: Dungeons have various difficulties: from Bronze, Silver, to Gold.");
        this.addProTip("enchant_blue_disk", "Pro Tip: Normal music discs can be enchanted into a blue version.");
        this.addProTip("harvest_aechor_poison", "Pro Tip: You can harvest Aechor Plant's poison with Skyroot Buckets.");
        this.addProTip("darts_no_gravity", "Pro Tip: Golden, Poison, and Enchanted Darts are not affected by gravity.");
        this.addProTip("dart_shooter_crafting", "Pro Tip: Dart Shooters can be crafted with Skyroot Planks and Golden Amber.");
        this.addProTip("remedy_bucket_enchanting", "Pro Tip: A Skyroot Remedy Bucket for poison can be obtained by enchanting poison.");
        this.addProTip("phoenix_armor_submerging", "Pro Tip: Try submerging yourself in water while wearing Phoenix armor.");
        this.addProTip("zephyr_shooting", "Pro Tip: Zephyrs shoot Snowballs with a force that can throw you off islands.");
        this.addProTip("aether_day_length", "Pro Tip: Days in the Aether realm last 3 times longer than surface days.");
        this.addProTip("sheepuff_puff", "Pro Tip: Sheepuff occasionally puff their wool out, making them float.");
        this.addProTip("victory_medal_drop", "Pro Tip: When Valkyries are defeated they will drop a Victory Medal.");
        this.addProTip("dig_straight_down", "Pro Tip: Never dig straight down.");
        this.addProTip("drops", "Pro Tip: If a drop looks too big, it probably is.");
        this.addProTip("shelter", "Pro Tip: A shelter made of dirt is still a shelter.");
        this.addProTip("creepers", "Pro Tip: Don't fear the Creeper.");
        this.addProTip("close_door", "Pro Tip: Don't leave your house without closing the door.");
        this.addProTip("watch_your_step", "Pro Tip: Watch where you step - deep shafts can be anywhere.");
        this.addProTip("check_surroundings", "Pro Tip: Always check your surroundings before entering a fight.");
        this.addProTip("mining", "Pro Tip: You can always come back later and mine some more.");
        this.addProTip("spare_stack", "Pro Tip: Always keep a spare stack of blocks in your active inventory.");
        this.addProTip("raw_meat", "Pro Tip: Raw meat is better than no meat.");
        this.addProTip("risk_taking", "Pro Tip: Don't take huge risks far from home.");
        this.addProTip("do_things", "Pro Tip: The best time to do anything is before it's too late.");
        this.addProTip("expectations", "Pro Tip: Never expect that nothing will happen while you're gone.");
        this.addProTip("respect", "Pro Tip: Always treat modders with respect.");
        this.addProTip("slimes", "Pro Tip: Slimes do exist... I think.");
        this.addProTip("security", "Pro Tip: Only give away your personal information to PayPal.");
        this.addProTip("difficulty", "Pro Tip: Easier rarely means funner.");
        this.addProTip("portal_misclick", "Pro Tip: Be careful not to misclick when building portals.");
        this.addProTip("the_game", "Pro Tip: The game is only as fun as you make it.");
        this.addProTip("golden_apples", "Pro Tip: The leaves of Golden Oak trees occasionally drop Golden Apples.");
