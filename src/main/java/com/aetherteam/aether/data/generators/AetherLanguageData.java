...
public class AetherLanguageData extends AetherLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addLore(AetherBlocks.AEROGEL, "The result of the Aether's unique climate and lava combining. These blocks can be crafted into various decorative blocks and is blast resistant.");
        ...
        addLore(AetherBlocks.SKYROOT_BED, "Crafted with wool and Skyroot Planks. You can only sleep at night to skip nighttime, but during the day you can set your respawn point in the Aether. Cannot sleep while mobs are nearby.");
        ...
        addLore(AetherItems.SKYROOT_BUCKET, "A hand crafted bucket, used to contain Aechor Plant poison, a nice remedy or even just plain water!");
        ...
        addLore(AetherItems.ZANITE_SHOVEL, "One of Aether's mid-tier tools, as you mine Aether Dirt and Quicksoil, the durability will decrease, and get faster. If you wait long enough it will start to break blocks instantly! Be careful repairing it, as it will be slower when there is more durability.");
