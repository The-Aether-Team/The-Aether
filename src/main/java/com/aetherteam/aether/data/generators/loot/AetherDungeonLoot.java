    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> builder) {
        builder.accept(AetherLoot.BRONZE_DUNGEON, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        ...
                        .add(LootTableReference.lootTableReference(AetherLoot.BRONZE_DUNGEON_DISC).setWeight(2))
        ...
        builder.accept(AetherLoot.BRONZE_DUNGEON_DISC, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(3.0F, 10.0F))
                        .add(LootItem.lootTableItem(AetherItems.AMBROSIUM_SHARD.get()).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 8.0F))))
                        .add(LootItem.lootTableItem(AetherBlocks.AMBROSIUM_TORCH.get()).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 16.0F))))
        ...
        builder.accept(AetherLoot.BRONZE_DUNGEON_REWARD, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(3.0F, 5.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_PICKAXE.get()).setWeight(1))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_SWORD.get()).setWeight(1))
        ...
        builder.accept(AetherLoot.BRONZE_DUNGEON_GUMMIES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 4.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherItems.GOLDEN_GUMMY_SWET.get()).setWeight(3))
                )
        );
        ...
        builder.accept(AetherLoot.SILVER_DUNGEON_LOOT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_SWORD.get()).setWeight(2))
                        .add(LootItem.lootTableItem(AetherBlocks.GRAVITITE_ORE.get()).setWeight(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
        ...
        builder.accept(AetherLoot.SILVER_DUNGEON_REWARD, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(6.0F, 12.0F))
                        .add(LootItem.lootTableItem(AetherItems.LIGHTNING_SWORD.get()).setWeight(14))
                        .add(LootItem.lootTableItem(AetherItems.HOLY_SWORD.get()).setWeight(14))
                        .add(LootItem.lootTableItem(AetherItems.INVISIBILITY_CLOAK.get()).setWeight(14))
                        .add(LootTableReference.lootTableReference(AetherLoot.SILVER_DUNGEON_GRAVITITE).setWeight(18))
                        .add(LootItem.lootTableItem(AetherItems.ENCHANTED_DART_SHOOTER.get()).setWeight(10))
                        .add(LootItem.lootTableItem(AetherItems.POISON_DART_SHOOTER.get()).setWeight(10))
                        .add(LootItem.lootTableItem(Items.GOLDEN_SWORD).setWeight(6))
                        .add(LootItem.lootTableItem(Items.IRON_SWORD).setWeight(6))
                        .add(LootItem.lootTableItem(AetherItems.ENCHANTED_BERRY.get()).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 8.0F))))
                        .add(LootItem.lootTableItem(AetherBlocks.ANGELIC_STONE.get()).setWeight(1))
                        .add(LootTableReference.lootTableReference(AetherLoot.SILVER_DUNGEON_VALKYRIE).setWeight(3))
                        .add(LootTableReference.lootTableReference(AetherLoot.SILVER_DUNGEON_NEPTUNE).setWeight(3))
        ...
        builder.accept(AetherLoot.SILVER_DUNGEON_TREASURE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(LootTableReference.lootTableReference(AetherLoot.SILVER_DUNGEON_VALKYRIE).setWeight(5))
                        .add(LootTableReference.lootTableReference(AetherLoot.SILVER_DUNGEON_NEPTUNE).setWeight(6))
                        .add(LootItem.lootTableItem(AetherItems.REGENERATION_STONE.get()).setWeight(3))
                        .add(LootItem.lootTableItem(AetherItems.REGENERATION_STONE.get()).setWeight(1).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2))))
                )
        );
        ...
        builder.accept(AetherLoot.SILVER_DUNGEON_NEPTUNE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
        ...
        builder.accept(AetherLoot.SILVER_DUNGEON_CAPE_CONFIG, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(AetherItems.VALKYRIE_CAPE.get()).setWeight(1).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1))).when(ConfigEnabled.isEnabled(AetherConfig.COMMON.spawn_valkyrie_cape)))
                        .add(LootItem.lootTableItem(AetherItems.GOLDEN_FEATHER.get()).setWeight(1).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1))).when(ConfigEnabled.isEnabled(AetherConfig.COMMON.spawn_golden_feather)))
                )
        );
        builder.accept(AetherLoot.SILVER_DUNGEON_GUMMIES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootItem.lootTableItem(AetherItems.BLUE_GUMMY_SWET.get()).setWeight(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 8.0F))))
                        .add(LootItem.lootTableItem(AetherItems.GOLDEN_GUMMY_SWET.get()).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 8.0F))))
                )
        );
        ...
        builder.accept(AetherLoot.GOLD_DUNGEON_REWARD, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(5.0F, 8.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_HELMET.get()).setWeight(6))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_CHESTPLATE.get()).setWeight(6))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_LEGGINGS.get()).setWeight(6))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_BOOTS.get()).setWeight(6))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_GLOVES.get()).setWeight(6))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_SWORD.get()).setWeight(6))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_AXE.get()).setWeight(6))
                        .add(LootItem.lootTableItem(AetherBlocks.ENCHANTED_GRAVITITE.get()).setWeight(2))
