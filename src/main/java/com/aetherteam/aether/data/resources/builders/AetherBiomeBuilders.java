    ...
    public static Biome makeDefaultBiome(BiomeGenerationSettings.Builder builder) {
        return fullDefinition(
                ...
                new MobSpawnSettings.Builder()
                        .addMobCharge(AetherEntityTypes.ZEPHYR.get(), 0.8, 0.1)
                        .addMobCharge(AetherEntityTypes.BLUE_SWET.get(), 0.6, 0.09)
                        .addMobCharge(AetherEntityTypes.GOLDEN_SWET.get(), 0.6, 0.09)
                        .addMobCharge(AetherEntityTypes.COCKATRICE.get(), 0.7, 0.12)
                        .addMobCharge(AetherEntityTypes.WHIRLWIND.get(), 0.5, 0.1)
                        .addMobCharge(AetherEntityTypes.EVIL_WHIRLWIND.get(), 0.5, 0.1)
                        .addMobCharge(AetherEntityTypes.AERWHALE.get(), 1, 0.12)
                        .addSpawn(AetherMobCategory.AETHER_SURFACE_MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.COCKATRICE.get(), 35, 1, 2))
                        .addSpawn(AetherMobCategory.AETHER_SKY_MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.ZEPHYR.get(), 40, 1, 1))
                        .addSpawn(AetherMobCategory.AETHER_SURFACE_MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.AECHOR_PLANT.get(), 4, 2, 6))
                        .addSpawn(AetherMobCategory.AETHER_SURFACE_MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.BLUE_SWET.get(), 5, 1, 1))
                        .addSpawn(AetherMobCategory.AETHER_SURFACE_MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.GOLDEN_SWET.get(), 5, 1, 1))
                        .addSpawn(AetherMobCategory.AETHER_SURFACE_MONSTER, new MobSpawnSettings.SpawnerData(AetherEntityTypes.WHIRLWIND.get(), 6, 1, 1))
                        ...
                        .addSpawn(AetherMobCategory.AETHER_AERWHALE, new MobSpawnSettings.SpawnerData(AetherEntityTypes.AERWHALE.get(), 20, 1, 1))
