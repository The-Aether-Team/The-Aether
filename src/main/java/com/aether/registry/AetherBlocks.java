...
public class AetherBlocks
{
	...
	public static final RegistryObject<TintedAercloudBlock> BLUE_AERCLOUD = registerAercloud("blue_aercloud",
	...
	public static final RegistryObject<TintedAercloudBlock> GOLDEN_AERCLOUD = registerAercloud("golden_aercloud",
	...
	public static final RegistryObject<Block> AMBROSIUM_WALL_TORCH = registerWithoutItem("ambrosium_wall_torch", () -> new WallTorchBlock(AbstractBlock.Properties.from(Blocks.WALL_TORCH), ParticleTypes.FLAME));
	public static final RegistryObject<Block> AMBROSIUM_TORCH = registerTorch("ambrosium_torch", () -> new TorchBlock(AbstractBlock.Properties.from(Blocks.TORCH), ParticleTypes.FLAME), AMBROSIUM_WALL_TORCH);
	...
	public static final RegistryObject<Block> TRAPPED_CARVED_STONE = register("trapped_carved_stone",
			() -> new TrappedBlock(() -> AetherEntityTypes.SENTRY, () -> LOCKED_CARVED_STONE.get().getDefaultState(), AbstractBlock.Properties.from(Blocks.BEDROCK)));
	public static final RegistryObject<Block> TRAPPED_SENTRY_STONE = register("trapped_sentry_stone",
			() -> new TrappedBlock(() -> AetherEntityTypes.SENTRY, () -> LOCKED_SENTRY_STONE.get().getDefaultState(), AbstractBlock.Properties.from(Blocks.BEDROCK).setLightLevel((state) -> 11)));
	...
	public static final RegistryObject<Block> CHEST_MIMIC = registerChest("chest_mimic", () -> new ChestMimicBlock(AbstractBlock.Properties.from(Blocks.CHEST)), () -> ClientProxy::chestMimicRenderer);
	public static final RegistryObject<Block> TREASURE_CHEST = registerChest("treasure_chest", () -> new TreasureChestBlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance(-1.0F, 3600000.0F)), () -> ClientProxy::treasureChestRenderer);
	...
	public static final RegistryObject<AetherPortalBlock> AETHER_PORTAL = registerWithoutItem("aether_portal", () -> new AetherPortalBlock(AbstractBlock.Properties.from(Blocks.NETHER_PORTAL)));
	...
	private static <B extends Block> RegistryObject<B> register(String name, Supplier<? extends B> block) {
		...
		AetherItems.ITEMS.register(name, () -> new BlockItem(Objects.requireNonNull(block.get()), new Item.Properties().group(AetherItemGroups.AETHER_BLOCKS)));
		return register;
	}

	private static <B extends Block> RegistryObject<B> registerWithoutItem(String name, Supplier<? extends B> block) {
		return BLOCKS.register(name, block);
	}

	private static <B extends Block> RegistryObject<B> registerAercloud(String name, Supplier<? extends B> block) {
		RegistryObject<B> register = BLOCKS.register(name, block);
		IAetherBlockColor iaetherblockcolor = (IAetherBlockColor) block.get();
		int hexColor = iaetherblockcolor.getColor(false);
		int updatedHexColor = iaetherblockcolor.getColor(true);
		AetherItems.ITEMS.register(name, () -> new TintedBlockItem(hexColor, updatedHexColor, block.get(), new Item.Properties().group(AetherItemGroups.AETHER_BLOCKS)));
		return register;
	}

	private static <B extends Block> RegistryObject<B> registerTorch(String name, Supplier<? extends B> block, Supplier<? extends B> wallBlock) {
		RegistryObject<B> register = BLOCKS.register(name, block);
		AetherItems.ITEMS.register(name, () -> new WallOrFloorItem(block.get(), wallBlock.get(), new Item.Properties().group(AetherItemGroups.AETHER_BLOCKS)));
		return register;
	}

	private static <B extends Block> RegistryObject<B> registerChest(String name, Supplier<? extends B> block, Supplier<Callable<ItemStackTileEntityRenderer>> render) {
		RegistryObject<B> register = BLOCKS.register(name, block);
		AetherItems.ITEMS.register(name, () -> new BlockItem(Objects.requireNonNull(block.get()), new Item.Properties().setISTER(render).group(AetherItemGroups.AETHER_BLOCKS)));
		return register;
	}
}