...
import com.aether.item.materials.SwetBallItem;
import com.aether.item.tools.*;
...
public class AetherItems
{
	...
	public static final RegistryObject<Item> GOLDEN_DART = ITEMS.register("golden_dart", () -> new DartItem(new Item.Properties().group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> POISON_DART = ITEMS.register("poison_dart", () -> new DartItem(new Item.Properties().group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> ENCHANTED_DART = ITEMS.register("enchanted_dart", () -> new DartItem(new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));

	public static final RegistryObject<Item> GOLDEN_DART_SHOOTER = ITEMS.register("golden_dart_shooter",
			() -> new DartShooterItem(GOLDEN_DART, new Item.Properties().maxStackSize(1).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> POISON_DART_SHOOTER = ITEMS.register("poison_dart_shooter",
			() -> new DartShooterItem(POISON_DART, new Item.Properties().maxStackSize(1).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> ENCHANTED_DART_SHOOTER  = ITEMS.register("enchanted_dart_shooter",
			() -> new DartShooterItem(ENCHANTED_DART, new Item.Properties().maxStackSize(1).rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	...
	public static final RegistryObject<Item> ZANITE_HELMET = ITEMS.register("zanite_helmet",
			() -> new AetherArmorItem(AetherArmorMaterial.ZANITE, EquipmentSlotType.HEAD, new Item.Properties().group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> ZANITE_CHESTPLATE = ITEMS.register("zanite_chestplate",
			() -> new AetherArmorItem(AetherArmorMaterial.ZANITE, EquipmentSlotType.CHEST, new Item.Properties().group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> ZANITE_LEGGINGS = ITEMS.register("zanite_leggings",
			() -> new AetherArmorItem(AetherArmorMaterial.ZANITE, EquipmentSlotType.LEGS, new Item.Properties().group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> ZANITE_BOOTS = ITEMS.register("zanite_boots",
			() -> new AetherArmorItem(AetherArmorMaterial.ZANITE, EquipmentSlotType.FEET, new Item.Properties().group(AetherItemGroups.AETHER_COMBAT)));

	public static final RegistryObject<Item> GRAVITITE_HELMET = ITEMS.register("gravitite_helmet",
			() -> new AetherArmorItem(AetherArmorMaterial.GRAVITITE, EquipmentSlotType.HEAD, new Item.Properties().group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> GRAVITITE_CHESTPLATE = ITEMS.register("gravitite_chestplate",
			() -> new AetherArmorItem(AetherArmorMaterial.GRAVITITE, EquipmentSlotType.CHEST, new Item.Properties().group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> GRAVITITE_LEGGINGS = ITEMS.register("gravitite_leggings",
			() -> new AetherArmorItem(AetherArmorMaterial.GRAVITITE, EquipmentSlotType.LEGS, new Item.Properties().group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> GRAVITITE_BOOTS = ITEMS.register("gravitite_boots",
			() -> new AetherArmorItem(AetherArmorMaterial.GRAVITITE, EquipmentSlotType.FEET, new Item.Properties().group(AetherItemGroups.AETHER_COMBAT)));

	public static final RegistryObject<Item> NEPTUNE_HELMET = ITEMS.register("neptune_helmet",
			() -> new AetherArmorItem(AetherArmorMaterial.NEPTUNE, EquipmentSlotType.HEAD, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> NEPTUNE_CHESTPLATE = ITEMS.register("neptune_chestplate",
			() -> new AetherArmorItem(AetherArmorMaterial.NEPTUNE, EquipmentSlotType.CHEST, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> NEPTUNE_LEGGINGS = ITEMS.register("neptune_leggings",
			() -> new AetherArmorItem(AetherArmorMaterial.NEPTUNE, EquipmentSlotType.LEGS, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> NEPTUNE_BOOTS = ITEMS.register("neptune_boots",
			() -> new AetherArmorItem(AetherArmorMaterial.NEPTUNE, EquipmentSlotType.FEET, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));

	public static final RegistryObject<Item> PHOENIX_HELMET = ITEMS.register("phoenix_helmet",
			() -> new AetherArmorItem(AetherArmorMaterial.PHOENIX, EquipmentSlotType.HEAD, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> PHOENIX_CHESTPLATE = ITEMS.register("phoenix_chestplate",
			() -> new AetherArmorItem(AetherArmorMaterial.PHOENIX, EquipmentSlotType.CHEST, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> PHOENIX_LEGGINGS = ITEMS.register("phoenix_leggings",
			() -> new AetherArmorItem(AetherArmorMaterial.PHOENIX, EquipmentSlotType.LEGS, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> PHOENIX_BOOTS = ITEMS.register("phoenix_boots",
			() -> new AetherArmorItem(AetherArmorMaterial.PHOENIX, EquipmentSlotType.FEET, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));

	public static final RegistryObject<Item> OBSIDIAN_HELMET = ITEMS.register("obsidian_helmet",
			() -> new AetherArmorItem(AetherArmorMaterial.OBSIDIAN, EquipmentSlotType.HEAD, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> OBSIDIAN_CHESTPLATE = ITEMS.register("obsidian_chestplate",
			() -> new AetherArmorItem(AetherArmorMaterial.OBSIDIAN, EquipmentSlotType.CHEST, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> OBSIDIAN_LEGGINGS = ITEMS.register("obsidian_leggings",
			() -> new AetherArmorItem(AetherArmorMaterial.OBSIDIAN, EquipmentSlotType.LEGS, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> OBSIDIAN_BOOTS = ITEMS.register("obsidian_boots",
			() -> new AetherArmorItem(AetherArmorMaterial.OBSIDIAN, EquipmentSlotType.FEET, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));

	public static final RegistryObject<Item> VALKYRIE_HELMET = ITEMS.register("valkyrie_helmet",
			() -> new AetherArmorItem(AetherArmorMaterial.VALKYRIE, EquipmentSlotType.HEAD, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> VALKYRIE_CHESTPLATE = ITEMS.register("valkyrie_chestplate",
			() -> new AetherArmorItem(AetherArmorMaterial.VALKYRIE, EquipmentSlotType.CHEST, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> VALKYRIE_LEGGINGS = ITEMS.register("valkyrie_leggings",
			() -> new AetherArmorItem(AetherArmorMaterial.VALKYRIE, EquipmentSlotType.LEGS, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	public static final RegistryObject<Item> VALKYRIE_BOOTS = ITEMS.register("valkyrie_boots",
			() -> new AetherArmorItem(AetherArmorMaterial.VALKYRIE, EquipmentSlotType.FEET, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));

	public static final RegistryObject<Item> SENTRY_BOOTS = ITEMS.register("sentry_boots",
			() -> new AetherArmorItem(AetherArmorMaterial.SENTRY, EquipmentSlotType.FEET, new Item.Properties().rarity(AETHER_LOOT).group(AetherItemGroups.AETHER_COMBAT)));
	...
	public static final RegistryObject<SpawnEggItem> PHYG_SPAWN_EGG = ITEMS.register("phyg_spawn_egg",
			() -> new SpawnEggItem(AetherEntityTypes.PHYG,0xFFC1D0, 0xFFD939, new Item.Properties().group(ItemGroup.MISC)));
	public static final RegistryObject<SpawnEggItem> FLYING_COW_SPAWN_EGG = ITEMS.register("flying_cow_spawn_egg",
			() -> new SpawnEggItem(AetherEntityTypes.FLYING_COW,0xD8D8D8, 0xFFD939, new Item.Properties().group(ItemGroup.MISC)));
	public static final RegistryObject<SpawnEggItem> SHEEPUFF_SPAWN_EGG = ITEMS.register("sheepuff_spawn_egg",
			() -> new SpawnEggItem(AetherEntityTypes.SHEEPUFF,0xE2FCFF, 0xCB9090, new Item.Properties().group(ItemGroup.MISC)));
	public static final RegistryObject<SpawnEggItem> MOA_SPAWN_EGG = ITEMS.register("moa_spawn_egg",
			() -> new SpawnEggItem(AetherEntityTypes.MOA,0x87BFEF, 0x7A7A7A, new Item.Properties().group(ItemGroup.MISC)));
	public static final RegistryObject<SpawnEggItem> AERWHALE_SPAWN_EGG = ITEMS.register("aerwhale_spawn_egg",
			() -> new SpawnEggItem(AetherEntityTypes.AERWHALE,0x79B7D1, 0xE0D25C, new Item.Properties().group(ItemGroup.MISC)));
	public static final RegistryObject<SpawnEggItem> WHIRLWIND_SPAWN_EGG = ITEMS.register("whirlwind_spawn_egg",
			() -> new SpawnEggItem(AetherEntityTypes.WHIRLWIND,0x9fc3f7, 0xffffff, new Item.Properties().group(ItemGroup.MISC)));
	public static final RegistryObject<SpawnEggItem> AECHOR_PLANT_SPAWN_EGG = ITEMS.register("aechor_plant_spawn_egg",
			() -> new SpawnEggItem(AetherEntityTypes.AECHOR_PLANT,0x076178, 0x4BC69E, new Item.Properties().group(ItemGroup.MISC)));
	public static final RegistryObject<SpawnEggItem> COCKATRICE_SPAWN_EGG = ITEMS.register("cockatrice_spawn_egg",
			() -> new SpawnEggItem(AetherEntityTypes.COCKATRICE,0x6CB15C, 0x6C579D, new Item.Properties().group(ItemGroup.MISC)));
	public static final RegistryObject<SpawnEggItem> ZEPHYR_SPAWN_EGG = ITEMS.register("zephyr_spawn_egg",
			() -> new SpawnEggItem(AetherEntityTypes.ZEPHYR,0xDFDFDF, 0x99CFE8, new Item.Properties().group(ItemGroup.MISC)));
	public static final RegistryObject<SpawnEggItem> SENTRY_SPAWN_EGG = ITEMS.register("sentry_spawn_egg",
			() -> new SpawnEggItem(AetherEntityTypes.SENTRY,0x808080,0x3A8AEC, new Item.Properties().group(ItemGroup.MISC)));
	public static final RegistryObject<SpawnEggItem> MIMIC_SPAWN_EGG = ITEMS.register("mimic_spawn_egg",
			() -> new SpawnEggItem(AetherEntityTypes.MIMIC,0xB18132,0x605A4E, new Item.Properties().group(ItemGroup.MISC)));
