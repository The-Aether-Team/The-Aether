...
import com.aether.event.SwettyBallGrowGrassEvent;
...
public class SwettyBallItem extends Item {

	public SwettyBallItem(Item.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (block == AetherBlocks.AETHER_DIRT) {
			newBlockState = AetherBlocks.AETHER_GRASS_BLOCK.getDefaultState();
