...
public class MoaModel extends EntityModel<MoaEntity> {
	...
	public MoaModel(float scale) {
		...
		this.legs.setRotationPoint(-2.0F, 0 + 16, 1.0F);
	...
	@Override
	public void setRotationAngles(MoaEntity moa, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (moa.isSitting()) {
			this.head.setRotationPoint(0.0F, -8 + 24, -4.0F);
			this.jaw.setRotationPoint(0.0F, -8 + 24, -4.0F);
			this.body.setRotationPoint(0.0F, 0 + 24, 0.0F);
			this.legs.setRotationPoint(-2.0F, 0 + 24, 1.0F);
			this.legs2.setRotationPoint(2.0F, 0 + 24, 1.0F);
			this.neck.setRotationPoint(0.0F, -2 + 24, -4.0F);
			this.feather1.setRotationPoint(0.0F, 1 + 24, 1.0F);
			this.feather2.setRotationPoint(0.0F, 1 + 24, 1.0F);
