...
public class AetherFeatures {
    ...
    public static void registerConfiguredFeatures() {
        ...
        RuleTest CRYSTAL_LEAVES = new BlockMatchRuleTest(AetherBlocks.CRYSTAL_LEAVES);
        ...
        register("crystal_fruit_leaves", Feature.ORE.withConfiguration(new OreFeatureConfig(HOLYSTONE, AetherBlocks.CRYSTAL_FRUIT_LEAVES.getDefaultState(), 4)).withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(64, 0, 128)).square().func_242731_b(240)));
